              ...
              <div className="flex items-center justify-between pt-6 border-t border-gray-100">
                <div className="flex items-center gap-6">
                  ...
                  <button
                    onClick={handleShare}
                    disabled={isSharing}
                    className={`flex items-center gap-2 px-4 py-2 text-gray-600 hover:bg-green-50 hover:text-green-600 rounded-lg transition-all duration-200 ${
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="text-center">
                ...
                <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-100">
                  ...
                  <div className="text-center">
                    <div className="text-lg font-bold text-gray-900">
                      {post.author.likesReceivedCount || 0}
                    </div>
                    <div className="text-xs text-gray-600">받은 좋아요</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-gray-900">
                      {post.author.commentsCount || 0}
                    </div>
                ...
                {post.author.socialLinks &&
                  Object.keys(post.author.socialLinks).length > 0 && (
