        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              잠시만 기다려주세요. 최신 기술 스택 정보를 가져오고 있습니다.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        ...
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            다양한 기술 스택을 검색하고 비교해보세요. 카테고리별로 분류된 최신
            기술 정보를 확인할 수 있습니다.
          </p>
        </div>
        ...
        {results.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {results.map((t) => (
              <Card
                key={t.slug}
                className="group bg-white/80 backdrop-blur-sm border-white/20 shadow-lg hover:shadow-2xl hover:bg-white/90 transition-all duration-300 rounded-2xl overflow-hidden"
              >
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center justify-between gap-3">
                    <Link
                      href={`/tech/${t.slug}`}
                      className="hover:text-blue-600 flex items-center gap-3 transition-colors"
                    >
                    ...
                    <Badge
                      className={`${getCategoryColor(t.category)} border-none`}
                    >
